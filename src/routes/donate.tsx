    ...
    >
      <div className="grid lg:grid-cols-5 gap-10">
        ...
        <div className="lg:col-span-3 bg-card rounded-xl p-8 shadow-card">
          ...
          <div className="mt-5 grid grid-cols-3 gap-3">
            {amounts.map((a) => (
              <button
                ...
                className={`py-3 rounded-md font-bold border-2 transition-smooth ${
                  selected === a
          ...
          <button
            type="button"
            className="mt-6 w-full inline-flex justify-center items-center gap-2 bg-gradient-accent text-accent-foreground font-bold px-6 py-4 rounded-md shadow-card hover:shadow-elegant hover:-translate-y-0.5 transition-smooth"
          >
